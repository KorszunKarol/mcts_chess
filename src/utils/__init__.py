...
This package now hosts both the Sentinel debugging system and the legacy
helper utilities that previously lived in src/utils.py.
"""

from .sentinel import Verbosity, sentinel
